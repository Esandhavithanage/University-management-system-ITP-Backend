...
employeeRoute.route('/addEmployee').post(function(req, res) {
    ...
    var sql = "INSERT INTO employee (`employeeId`, `name`, `address`, `gender`, `NIC`, `email`, `type`, `title`, `password`, `salaryId`, `timetableId` ) " +
        "VALUES('" + id + "', '" + name + "', '" + address + "', '" + gender + "', '" + nic + "', '" + email + "', '" + type + "', '" + title + "', '" + pwd + "', '" + salId + "', '" + timeTableId + "') ;";
...
employeeRoute.route('/updateEmployee').post(function(req, res) {
    ...
    var sql = "UPDATE employee SET name='" + name + "', address='" + address + "', gender='" + gender + "', NIC='" + nic + "', email='" + email + "', type='" + type + "', title='" + title + "', password='" + pwd + "', salaryId='" + salId + "', timetableId='" + timeTableId + "' " +
        "WHERE employeeId='" + id + "'; ";
